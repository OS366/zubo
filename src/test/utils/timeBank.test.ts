...
describe('Time Bank Utilities', () => {
  ...
  describe('addTimeToBank', () => {
    it('adds time to existing bank', () => {
      const initialBank = { totalSeconds: 100, earnedThisQuestion: 0 }
  ...
  describe('tradeTimeForLives', () => {
    it('trades 1000 seconds for 1 life', () => {
      const initialBank = { totalSeconds: 1500, earnedThisQuestion: 0 }
    ...
    it('trades 2000 seconds for 2 lives', () => {
      const initialBank = { totalSeconds: 2500, earnedThisQuestion: 0 }
    ...
    it('returns null when insufficient time for trade', () => {
      const initialBank = { totalSeconds: 500, earnedThisQuestion: 0 }
    ...
    it('handles exact trade amounts', () => {
      const initialBank = { totalSeconds: 1000, earnedThisQuestion: 0 }
      const updatedBank = tradeTimeForLives(initialBank, 1)
    ...
    it('handles large trades', () => {
      const initialBank = { totalSeconds: 5000, earnedThisQuestion: 0 }
  ...
  describe('Integration Tests', () => {
    ...
    it('calculates bonus points correctly', () => {
      const bank = { totalSeconds: 2000, earnedThisQuestion: 0 }
